...
#set_property IOSTANDARD TMDS_33 [get_ports clk_in_n]
#set_property LOC AD12 [get_ports clk_in_p]
#set_property IOSTANDARD TMDS_33 [get_ports clk_in_p]
...
## UART -- TXD, RXD naming uses terminal-centric naming convention
set_property -dict {PACKAGE_PIN Y23 IOSTANDARD LVCMOS33} [get_ports uart_rxd]
set_property -dict {PACKAGE_PIN Y20 IOSTANDARD LVCMOS33} [get_ports uart_txd]
...
## Audio Codec
set_property -dict {PACKAGE_PIN AH19 IOSTANDARD LVCMOS18} [get_ports audio_adc_sdata]
set_property -dict {PACKAGE_PIN AD19 IOSTANDARD LVCMOS18} [get_ports {audio_adr[0]}]
set_property -dict {PACKAGE_PIN AG19 IOSTANDARD LVCMOS18} [get_ports {audio_adr[1]}]
set_property -dict {PACKAGE_PIN AG18 IOSTANDARD LVCMOS18} [get_ports audio_bclk]
set_property -dict {PACKAGE_PIN AJ19 IOSTANDARD LVCMOS18} [get_ports audio_dac_sdata]
set_property -dict {PACKAGE_PIN AJ18 IOSTANDARD LVCMOS18} [get_ports audio_lrclk]
set_property -dict {PACKAGE_PIN AK19 IOSTANDARD LVCMOS18} [get_ports audio_mclk]
set_property -dict {PACKAGE_PIN AE19 IOSTANDARD LVCMOS18} [get_ports audio_scl]
set_property -dict {PACKAGE_PIN AF18 IOSTANDARD LVCMOS18} [get_ports audio_sda]
